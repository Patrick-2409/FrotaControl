...
export default function EmpresaExecutiveDashboardPage() {
  const { summary, loading, periodo } = useEmpresaExecutiveStats();
  ...
  return (
    <BIDashboardShell
      eyebrow="Indicadores"
      title="Executivo"
      lead="Visão consolidada da operação. Período padrão: semana (últimos 7 dias)."
      showRoadmap={false}
    >
      <p className="mb-4 text-xs font-medium uppercase tracking-wider text-zinc-500">
        Período: {periodo === "semana" ? "Semana atual" : periodo}
      </p>
      ...
      >
        ...
        <ExecutiveModuleCard title="Parte diária" to="/empresa/parte-diaria" accent="emerald">
          ...
          <p className="text-xs text-zinc-500">Lançamentos de parte diária na semana.</p>
        </ExecutiveModuleCard>
        ...
        <ExecutiveModuleCard title="Frota" to="/empresa/frota" accent="zinc">
          ...
          <p className="text-xs text-zinc-500">Veículos cadastrados na empresa.</p>
        </ExecutiveModuleCard>
        ...
        <ExecutiveModuleCard title="Pessoas" to="/empresa/pessoas" accent="violet">
          ...
          <p className="text-xs text-zinc-500">Com lançamento nos últimos 7 dias.</p>
        </ExecutiveModuleCard>
      </section>
    </BIDashboardShell>
  );
