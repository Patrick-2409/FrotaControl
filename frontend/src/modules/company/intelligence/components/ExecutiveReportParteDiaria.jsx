...
export default function ExecutiveReportParteDiaria({ parteDiaria = {}, loading = false, embedded = false }) {
  ...
  if (loading) {
    ...
    return embedded ? loadingShell : (
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">{loadingShell}</section>
    );
  }
