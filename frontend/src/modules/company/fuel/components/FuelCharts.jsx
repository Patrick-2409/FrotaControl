...
function FuelCharts({ pie, compact }) {
  return (
    <div className={`fc-erp-chart-surface min-w-0 ${compact ? "border-0 bg-transparent p-0" : ""}`}>
      {!compact ? (
        <>
      ...
      <div className={`mt-5 flex flex-col items-stretch gap-6 sm:mt-6 sm:flex-row sm:items-center sm:gap-8 ${compact ? "mt-0 sm:mt-0" : ""}`}>
        <div
